...
export const GlobalBrandsSection: React.FC = () => {
  ...
  return (
    <section className="relative py-20 md:py-28 bg-[#F8F9FA] text-zinc-900 border-t border-zinc-200/80 overflow-hidden">
      {/* Subtle Ambient Soft Glow Orb */}
      <div className="absolute top-1/4 -left-36 w-[32rem] h-[32rem] bg-[#F01B25]/5 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-3">
            <span className="text-xs font-mono-tech font-bold text-[#F01B25] tracking-widest uppercase">
              02 / GLOBAL BUYING NETWORK & OUR ASSOCIATES
            </span>
            <h2 className="text-4xl sm:text-6xl font-grotesk font-extrabold text-zinc-900 uppercase tracking-tight">
              YOUR GLOBAL <br />
              <span className="text-zinc-500">BUYING PARTNER.</span>
            </h2>
          </div>

          <p className="text-sm font-outfit text-zinc-600 max-w-md leading-relaxed">
        ...
        <div className="p-8 md:p-12 rounded-2xl bg-white border border-zinc-200 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-zinc-100 border border-zinc-200 text-xs font-mono-tech text-zinc-900">
              <Globe className="w-4 h-4 text-[#F01B25]" /> GLOBAL LOGISTICS FOOTPRINT
            </div>

            <h3 className="text-3xl font-grotesk font-bold text-zinc-900 uppercase leading-tight">
              CROSS-BORDER INDUSTRIAL PROCUREMENT.
            </h3>

            <p className="text-sm font-outfit text-zinc-600 leading-relaxed">
          ...
          <div className="lg:col-span-7">
            <div className="relative w-full h-[320px] sm:h-[380px] rounded-xl overflow-hidden border border-zinc-200 shadow-2xl group">
              <img
        ...
        <div className="space-y-8">
          <div className="flex items-center justify-between border-b border-zinc-200/80 pb-4">
            ...
            <span className="text-xs font-mono-tech text-zinc-500 font-semibold">STRATEGIC GLOBAL PARTNERSHIPS</span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 rounded-2xl bg-white border border-zinc-200/80 hover:border-[#F01B25]/60 transition-all duration-500 overflow-hidden shadow-xl group">
              <div className="overflow-hidden rounded-xl bg-zinc-50 border border-zinc-100 p-6 flex items-center justify-center min-h-[240px]">
                <img
                  src="/comp1.png"
